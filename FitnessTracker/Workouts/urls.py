...
urlpatterns = [
    ...
    path('workouts/<int:workout_pk>/exercises/<int:exercise_pk>/edit/', views.exercise_edit, name='exercise_edit'),
    path('workouts/<int:workout_pk>/exercises/<int:exercise_pk>/delete/', views.exercise_delete, name='exercise_delete'),
